(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/material/snack-bar'), require('luxon'), require('rrule'), require('rxjs'), require('@angular/common/http'), require('@angular/router'), require('rxjs/operators'), require('@angular/material/dialog'), require('algoliasearch'), require('@angular/cdk/a11y'), require('@angular/forms'), require('text-overflow-clamp'), require('@townscript/data-collector'), require('@townscript/elements'), require('@angular/material/core'), require('ng-recaptcha'), require('@angular/material/input'), require('@angular/material/progress-spinner'), require('@angular/material/tooltip'), require('ng-lazyload-image')) :
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/common', '@angular/material/snack-bar', 'luxon', 'rrule', 'rxjs', '@angular/common/http', '@angular/router', 'rxjs/operators', '@angular/material/dialog', 'algoliasearch', '@angular/cdk/a11y', '@angular/forms', 'text-overflow-clamp', '@townscript/data-collector', '@townscript/elements', '@angular/material/core', 'ng-recaptcha', '@angular/material/input', '@angular/material/progress-spinner', '@angular/material/tooltip', 'ng-lazyload-image'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.common, global.ng.material.snackBar, global.luxon, global.rrule, global.rxjs, global.ng.common.http, global.ng.router, global.rxjs.operators, global.ng.material.dialog, global.algoliaSearchImported, global.ng.cdk.a11y, global.ng.forms, global.clampLibImported, global.dataCollector, global.elements, global.ng.material.core, global.ngRecaptcha, global.ng.material.input, global.ng.material.progressSpinner, global.ng.material.tooltip, global.ngLazyloadImage));
}(this, (function (exports, core, common, snackBar, luxon, rrule, rxjs, http, router, operators, dialog, algoliaSearchImported, a11y, forms, clampLibImported, dataCollector, elements, core$1, ngRecaptcha, input, progressSpinner, tooltip, ngLazyloadImage) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NotificationService = /** @class */ (function () {
        function NotificationService(snackBar$1) {
            var _this = this;
    ...
    var PlaceService = /** @class */ (function () {
        ...
        PlaceService.ɵprov = core.ɵɵdefineInjectable({ factory: function PlaceService_Factory() { return new PlaceService(core.ɵɵinject(UtilityService), core.ɵɵinject(CookieService), core.ɵɵinject(common.DOCUMENT), core.ɵɵinject(core.PLATFORM_ID), core.ɵɵinject(http.HttpClient)); }, token: PlaceService, providedIn: "root" });
    ...
    var TsHeaderComponent = /** @class */ (function () {
        function TsHeaderComponent(utilityService, headerService, placeService, dialog$1, userService) {
            var _this = this;
            this.utilityService = utilityService;
            this.headerService = headerService;
            this.placeService = placeService;
        ...
        __decorate([
            core.ViewChild('citySuggestions')
        ], TsHeaderComponent.prototype, "citySuggestions", void 0);
        __decorate([
            core.ViewChild('userMenuEle')
    ...
    var HamburgerMenuComponent = /** @class */ (function () {
        function HamburgerMenuComponent(dialog$1, datepipe, router) {
            var _this = this;
            this.dialog = dialog$1;
            this.datepipe = datepipe;
            this.router = router;
    ...
    var EmailSentSVGComponent = /** @class */ (function () {
        ...
        EmailSentSVGComponent = __decorate([
            core.Component({
                ...
                styles: ["@keyframes open{0%{opacity:.2;transform:translateY(10%)}70%{opacity:.9;transform:translateY(-3%)}100%{opacity:1;transform:none}}#Card-Link{animation-name:open;animation-duration:1.5s;animation-iteration-count:1;overflow:hidden}"]
            })
    ...
    var FollowComponent = /** @class */ (function () {
        function FollowComponent(userService, followService, dialog$1) {
            var _this = this;
            this.userService = userService;
    ...
    var ConfirmationSVGComponent = /** @class */ (function () {
        ...
        ConfirmationSVGComponent = __decorate([
            core.Component({
                ...
                styles: ["@keyframes fadeInAnimation{0%{opacity:0;transform:none}50%{opacity:.5;transform:scale(1.2)}100%{opacity:1;transform:none}}svg{position:relative}path{animation-duration:.4s;animation-fill-mode:both;animation-delay:0s;animation-name:fadeInAnimation;transform-origin:center}@keyframes fill{from{height:0}}.left-line{animation-duration:.2s;animation-fill-mode:both;animation-delay:.25s;animation-name:fill}.right-line{animation-duration:.5s;animation-fill-mode:both;animation-delay:.4s;animation-name:fill}"]
            })
