(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/material'), require('luxon'), require('rxjs'), require('@angular/common/http'), require('@angular/router'), require('rxjs/operators'), require('@angular/material/dialog'), require('algoliasearch'), require('@angular/cdk/a11y'), require('@angular/forms'), require('text-overflow-clamp'), require('@townscript/data-collector'), require('@townscript/elements'), require('@angular/material/core'), require('@angular/material/snack-bar'), require('ng-recaptcha'), require('@angular/material/progress-spinner'), require('ng-lazyload-image')) :
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/common', '@angular/material', 'luxon', 'rxjs', '@angular/common/http', '@angular/router', 'rxjs/operators', '@angular/material/dialog', 'algoliasearch', '@angular/cdk/a11y', '@angular/forms', 'text-overflow-clamp', '@townscript/data-collector', '@townscript/elements', '@angular/material/core', '@angular/material/snack-bar', 'ng-recaptcha', '@angular/material/progress-spinner', 'ng-lazyload-image'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.common, global.ng.material, global.luxon, global.rxjs, global.ng.common.http, global.ng.router, global.rxjs.operators, global.ng.material.dialog, global.algoliaSearchImported, global.ng.cdk.a11y, global.ng.forms, global.clampLibImported, global.dataCollector, global.elements, global.ng.material.core, global.ng.material['snack-bar'], global.ngRecaptcha, global.ng.material['progress-spinner'], global.ngLazyloadImage));
}(this, (function (exports, core, common, material, luxon, rxjs, http, router, operators, dialog, algoliaSearchImported, a11y, forms, clampLibImported, dataCollector, elements, core$1, snackBar, ngRecaptcha, progressSpinner, ngLazyloadImage) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TsListingCardComponent = /** @class */ (function () {
        ...
        TsListingCardComponent.ctorParameters = function () { return [
            { type: UtilityService },
            { type: material.MatDialog },
            { type: BrowserService },
            { type: PlaceService }
    ...
    exports.ɵd = ConfirmationSVGComponent;
    exports.ɵe = TsListingEventCardComponent;
