(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/material'), require('luxon'), require('rxjs'), require('@angular/common/http'), require('@angular/router'), require('rxjs/operators'), require('@angular/material/dialog'), require('algoliasearch'), require('@angular/forms'), require('ng-recaptcha'), require('text-overflow-clamp'), require('@townscript/data-collector'), require('@townscript/elements'), require('@angular/material/core'), require('@angular/material/snack-bar'), require('@angular/material/progress-spinner'), require('ng-lazyload-image')) :
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/common', '@angular/material', 'luxon', 'rxjs', '@angular/common/http', '@angular/router', 'rxjs/operators', '@angular/material/dialog', 'algoliasearch', '@angular/forms', 'ng-recaptcha', 'text-overflow-clamp', '@townscript/data-collector', '@townscript/elements', '@angular/material/core', '@angular/material/snack-bar', '@angular/material/progress-spinner', 'ng-lazyload-image'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.common, global.ng.material, global.luxon, global.rxjs, global.ng.common.http, global.ng.router, global.rxjs.operators, global.ng.material.dialog, global.algoliaSearchImported, global.ng.forms, global.ngRecaptcha, global.clampLibImported, global.dataCollector, global.elements, global.ng.material.core, global.ng.material['snack-bar'], global.ng.material['progress-spinner'], global.ngLazyloadImage));
}(this, function (exports, core, common, material, luxon, rxjs, http, router, operators, dialog, algoliaSearchImported, forms, ngRecaptcha, clampLibImported, dataCollector, elements, core$1, snackBar, progressSpinner, ngLazyloadImage) { 'use strict';
