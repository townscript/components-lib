(function (global, factory) {
    ...
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.common, global.ng.material, global.luxon, global.rxjs, global.ng.common.http, global.ng.router, global.rxjs.operators, global.ng.material.dialog, global.algoliaSearchImported, global.ng.cdk.a11y, global.ng.forms, global.ngRecaptcha, global.clampLibImported, global.dataCollector, global.elements, global.ng.material.core, global.ng.material['snack-bar'], global.ng.material['progress-spinner'], global.ngLazyloadImage));
}(this, function (exports, core, common, material, luxon, rxjs, http, router, operators, dialog, algoliaSearchImported, a11y, forms, ngRecaptcha, clampLibImported, dataCollector, elements, core$1, snackBar, progressSpinner, ngLazyloadImage) { 'use strict';
